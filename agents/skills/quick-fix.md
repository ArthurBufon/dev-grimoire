...
2. Antes do patch, detectar alterações concorrentes desde o baseline; em arquivo compartilhado, preservar os trechos do dev e parar se houver conflito sem resolução inequívoca.
