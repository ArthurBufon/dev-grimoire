...
Interview the user rigorously about unresolved decisions until you reach a shared understanding. Do not ask about facts already answered by the plan, specs, rules, or codebase. Walk down each remaining branch of the design tree, resolving dependencies between decisions one-by-one. For each question, provide your recommended answer.
